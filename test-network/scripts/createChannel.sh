...
echo "Jea Digital Business Network end-to-end test"
echo
sleep 3
CHANNEL_NAME="$1"
DELAY="$2"
...
echo
echo
echo "========= All GOOD, JEA Digital Business Network up and running successfully =========== "
echo
echo "========= EXECUTE "docker ps -a" command to view HLF network containers =========== "
exit 0
